...
struct ParticleVertex
{
	...
	D3DVECTOR velocity;
	float birthScale, deathScale; //particle will grow as it does.
	unsigned int birthColor;
	unsigned int deathColor;
};
...
class CMyD3DApplication : public CD3DApplication
{
	...
	CD3DMesh*     m_pJunk;							// Random object just for the scene
...
protected:
	...
	void setupParticle(ParticleVertex* vertexData, int index, D3DVECTOR center, float birthSize, float deathSize,
								  unsigned int color);

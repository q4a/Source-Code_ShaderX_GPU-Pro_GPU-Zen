...
class NVEffectDevice_CgFX : public INVEffectDevice_CgFX
{
public:
	...
	virtual bool INTCALLTYPE CreateEffectFromFile(LPCSTR pSrcFile, DWORD Flags, INVEffect** pEffect, const char** ppCompilationErrors);

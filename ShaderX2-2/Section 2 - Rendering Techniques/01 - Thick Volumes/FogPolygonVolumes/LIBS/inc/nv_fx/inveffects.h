...
public:
	...
	virtual HRESULT INTCALLTYPE GetDesc(NVFXEFFECT_DESC* pDesc) = 0;
...
public:
	...
	virtual bool INTCALLTYPE CreateEffectFromFile(LPCSTR pSrcFile, DWORD Flags, INVEffect** pEffect, const char** ppCompilationErrors) = 0;

...
{
public:
	virtual bool EffectParamInit(nv_fx::INVEffect* pEffect, NVType& Param) = 0;
};
...
public:
	...
	virtual bool INTCALLTYPE AddEffect(nv_fx::INVEffect* pEffect) = 0;
	virtual bool INTCALLTYPE ApplyEffect(nv_fx::INVEffect* pEffect, INVParameterList* pList) = 0;
	virtual bool INTCALLTYPE RemoveEffect(nv_fx::INVEffect* pEffect) = 0;
	...
	virtual INVParameterList* INTCALLTYPE CreateParameterList(nv_fx::INVEffect* pEffect) = 0;

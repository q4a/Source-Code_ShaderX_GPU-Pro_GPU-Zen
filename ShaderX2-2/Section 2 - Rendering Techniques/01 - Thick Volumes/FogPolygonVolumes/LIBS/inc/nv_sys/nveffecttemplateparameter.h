...
public:
	...
	virtual bool Setup(INVConnectionManager* pConfigurationManager, nv_fx::INVEffect* pEffect, const unsigned int iParameter);
	virtual void Dump();
	virtual const nv_fx::NVFXPARAMETER_DESC* GetDesc() const;
...
private:
	...
	std::auto_ptr<nv_fx::NVFXPARAMETER_DESC> m_pParamDesc;
	std::auto_ptr<NVCgFXType> m_pParameter;
	DWORD m_dwRefCount;
	nv_fx::INVEffect* m_pEffect;

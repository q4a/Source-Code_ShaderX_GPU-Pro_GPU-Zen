...
public:
	...
	virtual bool Setup(INVConnectionManager* pManager, nv_fx::INVEffect* pEffect, const unsigned int iParameter) = 0;
	virtual void Dump() = 0;
	virtual const nv_fx::NVFXPARAMETER_DESC* GetDesc() const = 0;

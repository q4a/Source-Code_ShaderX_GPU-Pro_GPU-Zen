...
typedef std::map<nv_fx::INVEffect*, tvecEffectTemplateParameters> tmapEffectTemplateParameters;
...
public:
	...
	virtual bool INTCALLTYPE AddEffect(nv_fx::INVEffect* pEffect);
	virtual bool INTCALLTYPE RemoveEffect(nv_fx::INVEffect* pEffect);
	virtual bool INTCALLTYPE ApplyEffect(nv_fx::INVEffect* pEffect, INVParameterList* pList);
	virtual INVParameterList* INTCALLTYPE CreateParameterList(nv_fx::INVEffect* pEffect);

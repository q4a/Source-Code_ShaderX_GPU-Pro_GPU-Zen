...
typedef enum eSEMANTICID
{
	...
	SEMANTICID_NORMALMAP,				/*!< A texture map with normals in it */
	...
	SEMANTICID_WORLDT,					/*!< A transposed world matrix */
	SEMANTICID_VIEWT,					/*!< A transposed view matrix */
	SEMANTICID_PROJECTIONT,				/*!< A transposed projection matrix */
	SEMANTICID_WORLDI,					/*!< An inverted world matrix */
	SEMANTICID_VIEWI,					/*!< An inverted view matrix */
	SEMANTICID_PROJECTIONI,				/*!< An inverted projection matrix */
	SEMANTICID_WORLDIT,					/*!< An inverse transposed world matrix */
	SEMANTICID_VIEWIT,					/*!< An inverse transposed view matrix */
	SEMANTICID_PROJECTIONIT,			/*!< An inverse transposed projection matrix */
	SEMANTICID_WORLDVIEW,				/*!< A world view matrix */
	SEMANTICID_WORLDVIEWPROJECTION,		/*!< A world view projection matrix */
	SEMANTICID_WORLDVIEWT,				/*!< A transposed world view matrix */
	SEMANTICID_WORLDVIEWPROJECTIONT,	/*!< A transposed world view projection matrix */
	SEMANTICID_WORLDVIEWI,				/*!< An inverse world view matrix */
	SEMANTICID_WORLDVIEWPROJECTIONI,	/*!< An inverse world view projection matrix */
	SEMANTICID_WORLDVIEWIT,				/*!< An inverse transposed world view matrix */
	SEMANTICID_WORLDVIEWPROJECTIONIT,	/*!< An inverse transposed world view projection matrix*/
	...
	SEMANTICID_RANGE,					/*!< A range value */

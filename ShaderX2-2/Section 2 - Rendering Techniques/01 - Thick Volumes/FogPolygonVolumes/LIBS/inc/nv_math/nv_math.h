...
#ifdef _DLL
    #pragma message("  nv_math_mtdll_vc7.lib       (MULTITHREADED DLL)\n")
    #pragma comment(lib,"nv_math_mtdll_vc7.lib")
#else
    #ifdef _MT
	    #pragma message("  nv_math_mt_vc7.lib          (MULTITHREADED)\n")
        #pragma comment(lib,"nv_math_mt_vc7.lib")
    #else
	    #pragma message("  nv_math_vc7.lib             (SINGLE THREADED)\n")
        #pragma comment(lib,"nv_math_vc7.lib")
    #endif
#endif
#else
#ifdef _DLL
    #pragma message("  nv_math_mtdll.lib           (MULTITHREADED DLL)\n")
    #pragma comment(lib,"nv_math_mtdll.lib")
#else
    #ifdef _MT
	    #pragma message("  nv_math_mt.lib              (MULTITHREADED)\n")
        #pragma comment(lib,"nv_math_mt.lib")
    #else
	    #pragma message("  nv_math.lib                 (SINGLE THREADED)\n")

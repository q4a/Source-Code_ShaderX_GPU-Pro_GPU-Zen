...
#ifndef _H_NVD3DCOMMON_MATRIXNODE_H_
#define _H_NVD3DCOMMON_MATRIXNODE_H_


#include <NVD3DVers.h>		// your own app should contain this file in its
							//  #include path to select between D3D8 and D3D9 

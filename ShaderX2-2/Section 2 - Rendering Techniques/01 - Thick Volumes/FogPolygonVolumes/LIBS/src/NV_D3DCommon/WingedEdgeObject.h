...
#ifndef __NV_WINGEDEDGEOBJECT_H__
#define __NV_WINGEDEDGEOBJECT_H__
...
class WingedEdgeObject : public SimpleObject
{
public:
...
private:
	...
	HRESULT AllocateData( UINT numverts, UINT numtris );
...
public:
	...
	WingedEdgeObject();
	virtual ~WingedEdgeObject();

	friend class ShadowVolumeObject;
};




#endif		// __NV_WINGEDEDGEOBJECT8_H__
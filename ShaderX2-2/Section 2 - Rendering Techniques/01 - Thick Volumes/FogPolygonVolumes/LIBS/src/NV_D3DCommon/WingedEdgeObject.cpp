...
Comments:
1/27/2003 - Separating WingedEdgeObject from WingedEdgeObject for unified
	D3D8 and D3D9 codebase
...
WingedEdgeObject::WingedEdgeObject()
{
	::SimpleObject();
...
void WingedEdgeObject::SetToConstructionValues()
{
...
HRESULT WingedEdgeObject::FreeTemporaryData()
{
...
HRESULT WingedEdgeObject::AllocateData( UINT numverts, UINT numtris )
{
...
//	memset( m_wTriVertexIndicesToCollapsedSet, 0, sizeof(UINT) * numtris * 3 );

	return( S_OK );
}


void WingedEdgeObject::ReverseWinding()
{
...
bool	WingedEdgeObject::IsWingedEdgeDataBuilt()
{
	return( m_bWingedEdgeDataBuilt );
}


void	WingedEdgeObject::Warning_OpenHull()
{
...
void	WingedEdgeObject::Warning_SoloEdge()
{
...
SimpleObject  ** WingedEdgeObject::GenerateWingedEdgeMarkers()
{
...
void	WingedEdgeObject::BuildNonDegeneratePositions()
{
...
void	WingedEdgeObject::BuildNonEdgeDegenerateTris()
{
	assert( m_pCollapsedVertexSet != NULL );
...
void WingedEdgeObject::CompareTris( const std::vector< UINT > & set1,
...
HRESULT  WingedEdgeObject::BuildWingedEdgeData()
{
...
void WingedEdgeObject::WeldFacetedFaces( float threshold )
{
...
void WingedEdgeObject::RemoveUnusedVerts()
{

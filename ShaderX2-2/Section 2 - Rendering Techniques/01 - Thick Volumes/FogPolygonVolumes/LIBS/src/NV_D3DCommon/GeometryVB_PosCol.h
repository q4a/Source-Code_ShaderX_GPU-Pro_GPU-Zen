...
Vertex buffer geometry with position & color
...
#ifndef __NV_POSCOLORVERTEX_89_H
#define __NV_POSCOLORVERTEX_89_H
...
public:
	...
	VertexPC_Decl()
	{
		...
		m_pDecl[i++] = D3DVSD_REG(1, D3DVSDT_D3DCOLOR );
...
class GeometryVB_PC	: public SimpleVBObject
{

/* BASS 1.3 C/C++ header file, copyright (c) 1999-2001 Ian Luck.
...
#define BASS_ERROR_NOOGG	36	// OGG.DLL/VORBIS.DLL could not be loaded
...
BOOL BASSDEF(BASS_GetDeviceDescription)(DWORD devnum, char **desc);
...
pos    : the position
    ...
    if HSTREAM: position in bytes, file streams only (MP3/MP2/MP1/OGG require BASS_MP3_SETPOS)

...
//********************************************************************************************************************
//*
//*				History:			02/21/2004		- Fixed some errors/warnings in DX9 debug print-out			(kp)
//*
//********************************************************************************************************************
//********************************************************************************************************************
...
void SKYDOME::Init												(	IGN_OBJIF_GfxContext*	a_pGfxContextInterface )
{
	...
	if( NULL != a_pGfxContextInterface )
	{
		...
		if( NULL != m_pTextureBlock0 )
		{
			...
			//
			m_pTextureBlock0->SetTextureCoordinateTrafo( IGNTEXCOORDTRAFO_PROJECTED );
	...
	m_pSun->SetTime( 1990, 11, 28, 14, 30 );
	m_pSun->Prepare();

	m_pMoon	= new MOON( a_pGfxContextInterface );
	m_pMoon->SetTime( 1990, 11, 28, 14, 30 );

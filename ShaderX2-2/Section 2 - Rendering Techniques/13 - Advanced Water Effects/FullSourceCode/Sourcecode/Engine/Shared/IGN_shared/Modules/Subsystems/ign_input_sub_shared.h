...
struct			IGN_STRUCT_ImmKeyboardData;
struct			IGN_STRUCT_ImmMouseData;
struct			IGN_OBJIF_InpInstance;
struct			IGN_OBJIF_InpContext;
struct			IGN_OBJIF_InpImmKeyboard;
struct			IGN_OBJIF_InpImmMouse;
...
typedef		IGN_OBJIF_InpImmKeyboard*		IGN_LP_OBJIF_InpImmKeyboard;
typedef		IGN_OBJIF_InpImmMouse*			IGN_LP_OBJIF_InpImmMouse;
...
// Context methods																				
//
typedef			IGNRESULT	IGN_OBJCALL	IGN_METHOD_InpContext_CreateImmKeyboard				(			IGN_ENUM_COOPLEVEL				a_CoOpLevel,
																										IGN_LP_OBJIF_InpImmKeyboard&	a_pImmKeyboardInterface		);																				
typedef			IGNRESULT	IGN_OBJCALL	IGN_METHOD_InpContext_CreateImmMouse				(			IGN_ENUM_COOPLEVEL				a_CoOpLevel,
																										IGN_LP_OBJIF_InpImmMouse&		a_pImmMouseInterface		);

//////////////////////////////////////////////////////////////////////////////////////////////////////
//
// ImmediateKeyboard methods																				
//
typedef			IGNRESULT	IGN_OBJCALL	IGN_METHOD_InpImmKeyboard_GetData					(			IGN_STRUCT_ImmKeyboardData&		a_Data						);

//////////////////////////////////////////////////////////////////////////////////////////////////////
//
// ImmediateMouse methods																				
//
typedef			IGNRESULT	IGN_OBJCALL	IGN_METHOD_InpImmMouse_SetMode						(			IGN_ENUM_INPMOUSEMODE			a_Mode						);
typedef			IGNRESULT	IGN_OBJCALL	IGN_METHOD_InpImmMouse_GetMode						(			IGN_ENUM_INPMOUSEMODE&			a_Mode						);
typedef			IGNRESULT	IGN_OBJCALL	IGN_METHOD_InpImmMouse_GetData						(			IGN_STRUCT_ImmMouseData&		a_Data						);
...
IGN_OBJ_INTERFACE_DECL_BaseObject( IGN_OBJIF_InpContext )
{
	...
	//
	// Creates a new IGN_OBJIF_InpImmKeyboard object
	//
	IGN_OBJ_METHOD(	IGN_METHOD_InpContext_CreateImmKeyboard,				CreateImmediateKeyboard			);

	//
	// Creates a new IGN_OBJIF_InpImmMouse object
	//
	IGN_OBJ_METHOD(	IGN_METHOD_InpContext_CreateImmMouse,					CreateImmediateMouse			);
};														
									
//////////////////////////////////////////////////////////////////////////////////////////////////////
//
// ImmediateKeyboard interface	
//
IGN_OBJ_INTERFACE_DECL_ExecutableObject( IGN_OBJIF_InpImmKeyboard )
{
	//
	// Version 1.0.0
	//
	...
	//
	IGN_OBJ_METHOD(	IGN_METHOD_InpImmKeyboard_GetData,						GetData							);
};														
									
//////////////////////////////////////////////////////////////////////////////////////////////////////
//
// ImmediateMouse interface	
//
IGN_OBJ_INTERFACE_DECL_ExecutableObject( IGN_OBJIF_InpImmMouse )
{
	//
	// Version 1.0.0
	//
	...
	//
	IGN_OBJ_METHOD(	IGN_METHOD_InpImmMouse_SetMode,							SetMode							);

	//
	// Gets the coordinates reporting mode
	//
	IGN_OBJ_METHOD( IGN_METHOD_InpImmMouse_GetMode,							GetMode							);

	//
	// Retrieves the current input snapshot (generated on latest Execute() call)
	//
	IGN_OBJ_METHOD(	IGN_METHOD_InpImmMouse_GetData,							GetData							);
};

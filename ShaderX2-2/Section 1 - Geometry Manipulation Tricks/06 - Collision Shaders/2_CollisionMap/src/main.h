...
public:
	...
	D3DXVECTOR4 &GetVelocity(){return velocity;}
	D3DXMATRIX *GetWorldMatrix( D3DXMATRIX *dest );
...
class CMyD3DApplication : public CD3DApplication
{
	...
	CShadowVolume*			m_pVolume;		// path volume
	...
	LPDIRECT3DTEXTURE9		m_pCatTex[2];		// texture
	LPDIRECT3DSURFACE9		m_pCatSurf[2];		// surface
	DWORD					m_iCatId;

	IDirect3DQuery9*		m_pQuery[BULLET_MAX][2][2];	// 

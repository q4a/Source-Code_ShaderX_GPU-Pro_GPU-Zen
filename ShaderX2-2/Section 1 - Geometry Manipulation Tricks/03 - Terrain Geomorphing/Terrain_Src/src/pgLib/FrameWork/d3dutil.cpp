...
#pragma warning(disable: 4514 4238 4189 4100 4239)
...
//-----------------------------------------------------------------------------
HRESULT D3DUtil_CreateTexture( LPDIRECT3DDEVICE8 pd3dDevice, const TCHAR* strTexture,
                               LPDIRECT3DTEXTURE8* ppTexture, D3DFORMAT d3dFormat, D3DXIMAGE_INFO* imgInfo)
{
    ...
    return D3DXCreateTextureFromFileEx( pd3dDevice, strPath, 
                ...
                D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 0, imgInfo, NULL, ppTexture );
}

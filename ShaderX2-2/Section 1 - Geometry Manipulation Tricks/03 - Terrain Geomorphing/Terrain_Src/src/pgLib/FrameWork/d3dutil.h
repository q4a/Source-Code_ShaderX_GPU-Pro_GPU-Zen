...
//-----------------------------------------------------------------------------
PGLIB_API VOID D3DUtil_InitMaterial( D3DMATERIAL8& mtrl, FLOAT r=0.0f, FLOAT g=0.0f,
...
//-----------------------------------------------------------------------------
PGLIB_API VOID D3DUtil_InitLight( D3DLIGHT8& light, D3DLIGHTTYPE ltType,
...
//-----------------------------------------------------------------------------
PGLIB_API HRESULT D3DUtil_CreateTexture( LPDIRECT3DDEVICE8 pd3dDevice, const TCHAR* strTexture,
                               LPDIRECT3DTEXTURE8* ppTexture,
                               D3DFORMAT d3dFormat = D3DFMT_UNKNOWN, D3DXIMAGE_INFO* imgInfo=NULL);
...
//-----------------------------------------------------------------------------
PGLIB_API HRESULT D3DUtil_SetColorKey( LPDIRECT3DTEXTURE8 pTexture, DWORD dwColorKey );
...
//-----------------------------------------------------------------------------
PGLIB_API HRESULT D3DUtil_CreateVertexShader( LPDIRECT3DDEVICE8 pd3dDevice, 
...
//-----------------------------------------------------------------------------
PGLIB_API D3DXMATRIX D3DUtil_GetCubeMapViewMatrix( DWORD dwFace );
...
//       position.
//-----------------------------------------------------------------------------
PGLIB_API D3DXQUATERNION D3DUtil_GetRotationFromCursor( HWND hWnd,
...
//-----------------------------------------------------------------------------
PGLIB_API HRESULT D3DUtil_SetDeviceCursor( LPDIRECT3DDEVICE8 pd3dDevice, HCURSOR hCursor,
                                 BOOL bAddWatermark );

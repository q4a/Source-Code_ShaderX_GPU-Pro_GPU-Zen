...
//-----------------------------------------------------------------------------
struct PGLIB_API D3DDeviceInfo
{
    // Device data
...
//-----------------------------------------------------------------------------
struct PGLIB_API D3DAdapterInfo
{
    // Adapter data
...
//-----------------------------------------------------------------------------
class PGLIB_API CD3DApplication
{
protected:
...
public:
	bool			  m_allowHardwareProcessing;

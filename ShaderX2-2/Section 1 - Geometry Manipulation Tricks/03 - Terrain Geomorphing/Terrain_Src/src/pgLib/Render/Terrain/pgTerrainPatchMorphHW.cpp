...
//
///////////////////////////////////////////////////////////////////
// $Id: pgTerrainPatchMorphHW.cpp,v 1.13 2003/03/09 18:15:24 daniel Exp $
///////////////////////////////////////////////////////////////////


#include "pgTerrainPatchMorphHW.h"
...
DWORD	pgTerrainPatchMorphHW::morphShader = NULL;


pgTerrainPatchMorphHW::pgTerrainPatchMorphHW(pgTerrain* nMaster, int nX, int nY) : pgTerrainPatchMorphSW(nMaster, nX,nY)
{
}


void
pgTerrainPatchMorphHW::init()
{
...
void
pgTerrainPatchMorphHW::deleteDeviceObjects()
{
...
bool
pgTerrainPatchMorphHW::restoreDeviceObjects()
{
	return pgTerrainPatchMorphSW::restoreDeviceObjects();
}


bool
pgTerrainPatchMorphHW::fillBuffers()
{
...
bool
pgTerrainPatchMorphHW::checkBuffers()
{
...
bool
pgTerrainPatchMorphHW::setupVertexShader()
{
...
bool
pgTerrainPatchMorphHW::setupTextureMatrix(D3DXMATRIX& nTexMatrix)
{

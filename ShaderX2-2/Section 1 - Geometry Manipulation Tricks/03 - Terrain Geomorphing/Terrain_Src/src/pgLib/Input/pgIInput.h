...
//
///////////////////////////////////////////////////////////////////
// $Id: pgIInput.h,v 1.2 2002/11/20 21:53:47 daniel Exp $
///////////////////////////////////////////////////////////////////

#ifndef __INPUT_HEADERFILE__
#define __INPUT_HEADERFILE__
...
public:
	...
	/// calculates a key from a string (string must be same as key enum)
	static pgIInput::KEY getKeyFromString(const class pgString& nStr);
	...
	/**
	 *  For some device type - such as mouse input - it is necessary
	 *  that the input device has access to the window procedure.
	 *  This method is automatically called by the framework for
	 *  every message that is received by the application.
	 */

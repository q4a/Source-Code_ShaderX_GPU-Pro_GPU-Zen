...
#define DISPID_XMLDOM_SCHEMACOLLECTION                  (DISPID_DOM_BASE)
...
#define DISPID_XMLDOM_SCHEMACOLLECTION_ADDCOLLECTION    (DISPID_XMLDOM_SCHEMACOLLECTION + 5)
#define DISPID_XMLDOM_SCHEMACOLLECTION__TOP             (DISPID_XMLDOM_SCHEMACOLLECTION + 6)

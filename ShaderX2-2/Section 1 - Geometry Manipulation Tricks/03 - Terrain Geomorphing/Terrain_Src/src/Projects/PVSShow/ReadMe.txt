========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : PVSShow
========================================================================


Diese PVSShow-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\PVSShow.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei PVSShow.rc eingebunden.
...
PVSShowDlg.h, PVSShowDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CPVSShowDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in PVSShow.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	PVSShow.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.

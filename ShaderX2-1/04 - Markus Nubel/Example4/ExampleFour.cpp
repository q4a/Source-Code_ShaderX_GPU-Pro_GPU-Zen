...
{
    m_strWindowTitle            = TEXT("ExampleFour: Layered Fog");
...
HRESULT CMyD3DApplication::CreateShaders()
{
	...
	if(FAILED(DXUtil_FindMediaFileCb(szShaderPath, sizeof(szShaderPath), _T("LayeredFog.vsh"))))
		return S_FALSE;
	...
	if(FAILED(DXUtil_FindMediaFileCb(szShaderPath, sizeof(szShaderPath), _T("LayeredFog.psh"))))
		return S_FALSE;
...
HRESULT CMyD3DApplication::SetShaderConstants()
{
	D3DXVECTOR4 vCamera(m_matPosition._41, m_matPosition._42, m_matPosition._43, m_matPosition._44);
								   ...
								   /* (height /  end / --   / -- )*/
    D3DXVECTOR4 fFog      = D3DXVECTOR4(200.0f, 1500.0f, 0.0f, 0.0f);

									/* light gray */
    D3DXVECTOR4 colFog    = D3DXVECTOR4(150.0f/255.0f, 150.0f/255.0f, 150.0f/255.0f, 0.0f/255.0f);

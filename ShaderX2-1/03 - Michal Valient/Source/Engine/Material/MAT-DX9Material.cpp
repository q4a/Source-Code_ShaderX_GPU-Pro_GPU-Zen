...
CDX9MaterialContext *CDX9Material::CreateContextFromXML(CXMLNode *Node, CBase3DObject *Object, CRenderSettings &Settings) {
    CDX9MaterialContext *Context = (CDX9MaterialContext *)CreateContext(Object);
    Context->FillFromXML(Node, Settings);
    return Context;
}

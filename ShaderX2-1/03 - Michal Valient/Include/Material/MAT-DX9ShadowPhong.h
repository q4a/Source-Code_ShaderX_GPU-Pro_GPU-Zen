...
class CDX9_MaterialShadowPhongContext : public CDX9MaterialContext {
public:
    ...
    CDX9_MaterialShadowPhongContext();
    virtual ~CDX9_MaterialShadowPhongContext();

    virtual void FillFromXML(CXMLNode *Node, CRenderSettings &Settings);
};

class CDX9_MaterialShadowPhong : public CDX9Material {
protected:
    DWORD   CurrentPass;
    CDX9_MaterialShadowPhongContext *CurrentContext;
    ...
    virtual ~CDX9_MaterialShadowPhong(void);
...
public:
    ...
    ///Const, dest & more
    CDX9_MaterialShadowPhong(char *ObjName,CEngine *OwnerEngine);

    MAKE_CLSCREATE(CDX9_MaterialShadowPhong);
    MAKE_CLSNAME("CDX9_MaterialShadowPhong");
    MAKE_DEFAULTGARBAGE()
};

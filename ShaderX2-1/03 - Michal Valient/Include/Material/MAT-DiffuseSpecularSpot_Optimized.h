...
class CMaterialDiffuseSpecularSpotOptimizedContext : public CDX8MaterialContext {
protected:
...
public:
    ...
    CMaterialDiffuseSpecularSpotOptimizedContext();
    virtual ~CMaterialDiffuseSpecularSpotOptimizedContext();
    virtual int QueryProperty(const char *PropertyName);
    virtual bool SetProperty(int PropertyID, const void *Property);
};

class CMaterialDiffuseSpecularSpotOptimized : public CDX8Material {
protected:
    CMaterialDiffuseSpecularSpotOptimizedContext *CurrentContext;
    ...
    virtual ~CMaterialDiffuseSpecularSpotOptimized(void);
...
public:
    ...
    ///Const, dest & more
    CMaterialDiffuseSpecularSpotOptimized(char *ObjName,CEngine *OwnerEngine);

    MAKE_CLSCREATE(CMaterialDiffuseSpecularSpotOptimized);
    MAKE_CLSNAME("CMaterialDiffuseSpecularSpotOptimized");
    MAKE_DEFAULTGARBAGE()
};

...
class CMaterialDiffuseSpecularPhongContext : public CDX8MaterialContext {
protected:
...
public:
    ...
    CMaterialDiffuseSpecularPhongContext();
    virtual ~CMaterialDiffuseSpecularPhongContext();
    virtual int QueryProperty(const char *PropertyName);
    virtual bool SetProperty(int PropertyID, const void *Property);
};

class CMaterialDiffuseSpecularPhong : public CDX8Material {
protected:
    CMaterialDiffuseSpecularPhongContext *CurrentContext;
    ...
    virtual ~CMaterialDiffuseSpecularPhong(void);
...
public:
    ...
    ///Const, dest & more
    CMaterialDiffuseSpecularPhong(char *ObjName,CEngine *OwnerEngine);

    MAKE_CLSCREATE(CMaterialDiffuseSpecularPhong);
    MAKE_CLSNAME("CMaterialDiffuseSpecularPhong");
    MAKE_DEFAULTGARBAGE()
};

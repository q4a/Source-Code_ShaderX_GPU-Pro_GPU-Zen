...
class CDX9_MaterialCookTorranceContext : public CDX9MaterialContext {
public:
    ...
    CDX9_MaterialCookTorranceContext();
    virtual ~CDX9_MaterialCookTorranceContext();

    virtual void FillFromXML(CXMLNode *Node, CRenderSettings &Settings);
};

class CDX9_MaterialCookTorrance : public CDX9Material {
protected:
    DWORD   ShaderVersion;
    DWORD   CurrentPass;
    CDX9_MaterialCookTorranceContext *CurrentContext;
    ...
    CBaseTexture    *Beckman;
    CBaseTexture    *Reciprocal;
    CBaseTexture    *Fresnel;
    ...
    virtual ~CDX9_MaterialCookTorrance(void);
...
public:
    ...
    ///Const, dest & more
    CDX9_MaterialCookTorrance(char *ObjName,CEngine *OwnerEngine);

    MAKE_CLSCREATE(CDX9_MaterialCookTorrance);
    MAKE_CLSNAME("CDX9_MaterialCookTorrance");
    MAKE_DEFAULTGARBAGE()
};

...
class CMaterialDiffuseSpecularSpotContext : public CDX8MaterialContext {
protected:
...
public:
    ...
    CMaterialDiffuseSpecularSpotContext();
    virtual ~CMaterialDiffuseSpecularSpotContext();
    virtual int QueryProperty(const char *PropertyName);
    virtual bool SetProperty(int PropertyID, const void *Property);
};

class CMaterialDiffuseSpecularSpot : public CDX8Material {
protected:
    CMaterialDiffuseSpecularSpotContext *CurrentContext;
    ...
    virtual ~CMaterialDiffuseSpecularSpot(void);
...
public:
    ...
    ///Const, dest & more
    CMaterialDiffuseSpecularSpot(char *ObjName,CEngine *OwnerEngine);

    MAKE_CLSCREATE(CMaterialDiffuseSpecularSpot);
    MAKE_CLSNAME("CMaterialDiffuseSpecularSpot");
    MAKE_DEFAULTGARBAGE()
};

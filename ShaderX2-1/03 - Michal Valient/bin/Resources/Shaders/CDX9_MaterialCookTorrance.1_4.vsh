...
//------------------------------
// Cook-Torrance lighting - Vertex shader
//
// Desc :
...
// oT4 - projective spotlight texture coordinates
...
mov r11.w, v1.w
m3x3 r9, v3, c0                     //generate tangent
mov r9.w, v3.w
...
dp3 r1.w, r0, r0                    //normalize the light vector
rsq r1.w, r1.w
mul r7, r0, r1.w
m3x3 oT1.xyz, r7, r9                //transform the light vector with N, T, NxT

add r0, c9, -r8                     //build the eye vector from vertex to camera source
dp3 r1.w, r0, r0                    //normalize the eye vector
rsq r1.w, r1.w
mul r6, r0, r1.w
m3x3 oT2.xyz, r6, r9                //transform the eye vector with N, T, NxT

add r0, r6, r7                      //build the half vector between light and eye
dp3 r1.w, r0, r0                    //normalize the half vector
rsq r1.w, r1.w
mul r5, r0, r1.w
m3x3 oT3.xyz, r5, r9                //transform the half vector with N, T, NxT

m4x4 oT4.xyzw, v0, c10              //compute projector texture coordinates from vertex position

...
; c9        - Vertex adjustment factor for cube map
;
; Input registers
; v0 - Position
; v1 - Normal
...
;------------------------------
;Per vertex adjustment for cube map position
;it is good for co planar normals, because
;we do not want to point them all to one place
;------------------------------
;
mul oT5, r8, c9.xxxx

...
;------------------------------
; Per pixel specular - Vertex shader
;
; Desc :
;   Renders specular part for one light per pixel
;
...
mul r0,r9.zxyw,r11.yzxw             ;cross prod to generate binormal
mad r10,r9.yzxw,r11.zxyw,-r0

m4x4 r8, v0, c0                     ;vertex into world position
...
dp3 oT1.x, r9, r7                   ;transform the light vector with S, T, SxT

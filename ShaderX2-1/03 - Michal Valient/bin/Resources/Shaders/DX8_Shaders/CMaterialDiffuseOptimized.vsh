...
//------------------------------
// Per pixel diffuse - Vertex shader
//
// Desc :
...
dp3 r2, r2, c16                     //in c16 we have modifiers of attenuation
...
//------------------------------
//
add r0, c9, -r8                     //Build the light vector from light source to vertex
                                    //normalize the light vector (d stands for distance)
dp3 r2.w, r0, r0                    //r2.w = r0 * r0 = (x*x) + (y*y) + (z*z)
rsq r1.w, r2.w	                    //r1.w = 1/d = 1/||V|| = 1/sqrt(r2.w)
mul r7, r0, r1.w                    //r7 = r0 * (1/d) = r0/d
...
//------------------------------
//
add r0, c10, -r8                    //Build the light vector from light source to vertex
                                    //normalize the light vector (d stands for distance)
dp3 r2.w, r0, r0                    //r2.w = r0 * r0 = (x*x) + (y*y) + (z*z)
rsq r1.w, r2.w	                    //r1.w = 1/d = 1/||V|| = 1/sqrt(r2.w)
mul r7, r0, r1.w                    //r7 = r0 * (1/d) = r0/d

...
public:
    ...
    // HACK: Hack to force textures to load from designated dir and flag to toggle compressing texture to dxt1
    HRESULT Create( LPDIRECT3DDEVICE8 pd3dDevice, TCHAR* strFileDir, TCHAR* strFilename, BOOL compressTex );

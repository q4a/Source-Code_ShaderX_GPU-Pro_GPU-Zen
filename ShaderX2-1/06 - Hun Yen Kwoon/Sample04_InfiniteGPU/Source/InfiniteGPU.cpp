...
//-----------------------------------------------------------------------------
CDepthFail::CDepthFail()
{
  m_strWindowTitle    = _T("InfiniteGPU Sample");
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::ConfirmDevice( D3DCAPS8* pCaps, DWORD dwBehavior, 
                                      D3DFORMAT Format )
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::OneTimeSceneInit()
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::InitDeviceObjects()
{
  // Load meshes
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::RestoreDeviceObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::InvalidateDeviceObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::DeleteDeviceObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::RenderScene()
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::FinalCleanup()
{
...
//-----------------------------------------------------------------------------
HRESULT CDepthFail::RenderShadowVolume()
{
  ...
  // Show shadow volume back faces? Sides will be masked out by stencil later
  ...
  // Show shadow volume front faces? Sides will be masked out by stencil later
...
//-----------------------------------------------------------------------------
LRESULT CDepthFail::MsgProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
  if ( WM_KEYDOWN == uMsg )
  {
    m_bKey[wParam] = 1;

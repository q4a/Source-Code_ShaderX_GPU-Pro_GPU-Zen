...
{
  m_strWindowTitle    = _T( "DepthFailCPU Sample" );
...
HRESULT CDepthFail::RestoreDeviceObjects()
{
  ...
  */
  ...
  // Set to infinite projection to avoid clipping shadow vol at far plane
...
HRESULT CDepthFail::RenderShadowVolume()
{
  ...
  // Draw back-side of shadow volume
  m_pd3dDevice->SetTransform( D3DTS_WORLD, &m_matObject);

#ifndef __SHADOWVOLUME_DEPTHPASSCPU_H__
#define __SHADOWVOLUME_DEPTHPASSCPU_H__
...
// class CDepthPass
//-----------------------------------------------------------------------------
class CDepthPass : public CD3DApplication
{
private:
  BOOL m_bKeyInfo;
  ...
  CD3DMesh*               m_pShadowObjectMesh;
  CD3DMesh*               m_pShadowObjectMesh2;
  ...
  D3DMATERIAL8            m_ShadowVolFrontFaceMaterial;
  D3DMATERIAL8            m_ShadowVolBackFaceMaterial;
...
#endif // __SHADOWVOLUME_DEPTHPASSCPU_H__